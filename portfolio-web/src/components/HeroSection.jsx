...
const HeroSection = () => {
  ...
  return (
    <section className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-black text-gray-800 dark:text-white relative overflow-hidden pt-16 sm:pt-20 pb-8 sm:pb-12">
      ...
      {/* Content */}
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 z-10 max-w-7xl h-full">
        <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-8 lg:gap-16 h-full py-4">
          
          {/* Left Content */}
          <motion.div 
            className="flex-1 text-center lg:text-left max-w-3xl w-full"
          ...
          >
            {/* Availability Badge */}
            <motion.div
              className="inline-flex items-center gap-2 bg-green-500/20 border border-green-500/30 rounded-full px-4 py-2 mb-4 sm:mb-6"
            ...
            >
              ...
              />
              <span className="text-green-300 dark:text-green-300 text-sm font-medium">Available for new opportunities</span>
            </motion.div>
            ...
            >
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl font-bold leading-tight mb-3 sm:mb-4">
                <motion.span 
            ...
            <motion.h2 
              className="text-lg sm:text-xl md:text-2xl lg:text-2xl xl:text-3xl font-medium text-gray-600 dark:text-gray-300 mb-4 sm:mb-6 h-8 sm:h-10 md:h-12 lg:h-14 flex items-center justify-center lg:justify-start"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            <motion.p 
              className="text-sm sm:text-base md:text-lg text-gray-500 dark:text-gray-400 mb-4 sm:mb-6 max-w-2xl leading-relaxed"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              >
                <motion.button 
                  className="w-full sm:w-auto bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold py-3 sm:py-4 px-6 sm:px-8 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl"
                  whileHover={{ 
                    scale: 1.05,
              ...
              >
                <motion.button 
                  className="w-full sm:w-auto border-2 border-blue-400 text-blue-400 hover:bg-blue-400 hover:text-white font-semibold py-3 sm:py-4 px-6 sm:px-8 rounded-xl transition-all duration-300"
                  whileHover={{ 
                    scale: 1.05,
      ...
      <motion.div 
        className="absolute bottom-4 sm:bottom-8 left-1/2 transform -translate-x-1/2 flex flex-col items-center cursor-pointer"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        <motion.span 
          className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm mb-2"
          animate={{ opacity: [0.5, 1, 0.5] }}
          transition={{ duration: 2, repeat: Infinity }}
        >
          Scroll to explore
        ...
        <motion.div
          ...
          className="w-5 sm:w-6 h-8 sm:h-10 border-2 border-gray-400 dark:border-gray-400 rounded-full flex justify-center"
        >
          <motion.div
            animate={{ y: [0, 12, 0] }}
            transition={{ repeat: Infinity, duration: 2 }}
            className="w-0.5 sm:w-1 h-2 sm:h-3 bg-gray-400 dark:bg-gray-400 rounded-full mt-2"
          />
        </motion.div>
      </motion.div>
    </section>
